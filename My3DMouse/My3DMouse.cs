...
namespace My3DMouse
{
    ...
    internal class My3DMouse
    {
        ...
        /// </summary>
        private static My3DMouse g_instance;

        /// <summary>
        /// Returns the one and only instance of this object
        /// </summary>
        public static My3DMouse Instance => g_instance ?? (g_instance = new My3DMouse());
        ...
        private void SerialPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            double rX = double.Parse(sp.ReadLine());

            var doc = RhinoDoc.ActiveDoc;
            var currentView = RhinoDoc.ActiveDoc.Views.ActiveView;

            currentView.ActiveViewport.Rotate(rX / 4000, Vector3d.ZAxis, Point3d.Origin);

            doc.Views.ActiveView.Redraw();

            //RhinoApp.WriteLine("Data received");
        ...
        public void OnInitialized(object sender, EventArgs e)
        {
            ...
            RhinoApp.WriteLine("Initialized true");
